...
# 3. **Temperature Converter**🏃‍♂️‍➡️🏃‍♂️‍➡️
...
# 2. **File Reader**
#     - Write a program to read a file. Handle the error if the file doesn’t exist.
...
#     - Write a program to safely access a key in a dictionary. Handle the error if the key doesn’t exist.
